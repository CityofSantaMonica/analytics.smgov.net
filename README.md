...
- `AZURE_WA_PASSWORD` - The password of the above user, also configured in the Azure Web App
...
Because the data files powering the dashboard are constantly being overwritten (at different intervals), we have another Python WebJob that takes the daily analytics reports and snapshots them in to our [open data portal](https://data.smgov.net).
